...
/**
 * Created by Domen、on 2018/3/20.
 */

public class FastBlur {

    public static void setBlurBg(Drawable drawable, View view, int radius) {
        ...
        int finalW = h * 9 / 16;
        view.setBackground(new BitmapDrawable(App.getAppContext().getResources(), doBlur(
                Bitmap.createBitmap(bitmap, (w - finalW) / 2, 0, finalW, h), radius)));
    }
