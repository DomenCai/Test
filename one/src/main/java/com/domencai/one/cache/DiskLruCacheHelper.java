package com.domencai.one.cache;
...
public class DiskLruCacheHelper {
    ...
    private DiskLruCache generateCache(Context context, File dir, int maxCount) throws IOException {
        ...
        return DiskLruCache.open(dir, appVersion, DEFAULT_VALUE_COUNT, maxCount);
    }

    private DiskLruCache generateCache(Context context, String dirName, int maxCount) throws
            IOException {
        return DiskLruCache.open(getDiskCacheDir(context, dirName), Utils.getAppVersion(context), DEFAULT_VALUE_COUNT, maxCount);
    }
    // =======================================
    // ============== String 数据 读写 =============
    // =======================================
