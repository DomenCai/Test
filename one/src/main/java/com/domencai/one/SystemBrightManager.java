...
/**
 * Created by Domen、on 2017/11/15.
 */
...
public class SystemBrightManager {
    ...
    public static boolean isAutoBrightness(Activity activity) {
        ...
        try {
            autoBrightness = Settings.System.getInt(contentResolver, Settings.System
    ...
    public static int getBrightness(Activity activity) {
        ...
        ContentResolver contentResolver = activity.getContentResolver();
        try {
            brightValue = Settings.System.getInt(contentResolver, Settings.System
                    .SCREEN_BRIGHTNESS);
        } catch (Settings.SettingNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public static void setBrightnessMode(Activity activity, int brightMode) {
        Settings.System.putInt(activity.getContentResolver(), Settings.System
                .SCREEN_BRIGHTNESS_MODE, brightMode);
    }
}
