package com.domencai.puzzle.blur;
...
public class BlurredView extends RelativeLayout {
    ...
    public void setBlurredLevel(int level) {
        ...
        mOriginImg.setAlpha(1 - level / 100f);
    }
     ...
     */
    @SuppressWarnings("unused")
    public void setBlurredTop(int high) {
        mOriginImg.setTop(-high);
        mBlurredImg.setTop(-high);
    }
